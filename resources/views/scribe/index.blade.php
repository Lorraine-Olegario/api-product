    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="atualizar-um-produto-existente">
                    <a href="#atualizar-um-produto-existente">Atualizar um produto existente</a>
                                ...
                                <a href="#atualizar-um-produto-existente-PUTapi-v1-products--id-">Atualiza os dados de um produto específico com base no ID.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="deletar-um-produto">
                    <a href="#deletar-um-produto">Deletar um produto</a>
                                ...
                                <a href="#deletar-um-produto-DELETEapi-v1-products--id-">Remove um produto específico com base no ID.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="exibir-um-produto-especifico">
                    <a href="#exibir-um-produto-especifico">Exibir um produto específico</a>
                </li>
...
<p>Esta é a documentação da API de produtos v1.</p>
<aside>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="atualizar-um-produto-existente">Atualizar um produto existente</h1>
                                ...
                                <h2 id="atualizar-um-produto-existente-PUTapi-v1-products--id-">Atualiza os dados de um produto específico com base no ID.</h2>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Preço do produto. Exemplo: 39.90 Example: <code>4326.41688</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Descrição do produto. Exemplo: &quot;Camiseta de algodão atualizada&quot; Example: <code>Eius et animi quos velit et.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Preço do produto. Exemplo: 29.90 Example: <code>4326.41688</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Descrição do produto. Exemplo: &quot;Camiseta de algodão&quot; Example: <code>Eius et animi quos velit et.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>URL da imagem do produto. Exemplo: &quot;<a href="http://example.com/image.jpg">http://example.com/image.jpg</a>&quot; Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
                ...
                <h1 id="deletar-um-produto">Deletar um produto</h1>
                                ...
                                <h2 id="deletar-um-produto-DELETEapi-v1-products--id-">Remove um produto específico com base no ID.</h2>
...
<p>ID do produto. Exemplo: 1 Example: <code>16</code></p>
                ...
                <h1 id="exibir-um-produto-especifico">Exibir um produto específico</h1>
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>Quantidade de itens por página. Padrão: 50. Exemplo: 10 Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
